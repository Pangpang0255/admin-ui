    ...
    <main className="min-h-screen bg-special-mainBg flex justify-center items-center">
      ...
      <div className="w-full max-w-sm">
        ...
        {/* form end */}
        				...
        				{/* teks start */}
<div className="my-9 px-7 flex items-center text-xs text-gray-03 w-full">
  <div className="flex-grow border-t border-gray-05"></div>
  <span className="mx-3 px-2 bg-special-mainBg">or sign in with</span>
  <div className="flex-grow border-t border-gray-05"></div>
</div>
{/* teks end */}
